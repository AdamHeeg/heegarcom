...
public sealed class TribeTime : IProjectSource
{
    ...
    public ProjectItem Card => new()
    {
        ...
        Problem = "Groups need reliable ways to send broadcast notifications without starting group chats!  Further, it's easy to have reminders and events get buried on our phones.  This can be solved with a broadcast application open to multiple groups, or tribes.",
        ...
        Outcome = "A successful communication tool to broadcast calendar events and notifications from a tribe leader to all members.  The notifications can be acknowledged and deleted.  Calendar events can be synced with the host phone system.  Wonderful lightweight solution to easy group communication with support for color coded tribes.",
        Metrics = new[]
        {
