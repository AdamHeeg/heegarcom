...
public sealed class AiIntegration : IProjectSource
{
    ...
    public ProjectItem Card => new()
    {
        ...
        <li><strong>Version 3:</strong> Agentic AI calls built through custom agents run in order to specialize in different tasks creating well-defined specialized content.</li>
